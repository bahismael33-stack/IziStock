        ...
        private void CreateDatabase()
        {
            ...
            using (var conn = GetDatabaseConnectionWithoutMigrating())
            {
                using (var command = GetSQLiteCommand(conn))
                {
                    ...
                    command.Parameters.Clear();
                    command.Parameters.AddWithValue("@name", "Dollar Américain");
                    ...
                    command.ExecuteNonQuery();
                    command.Parameters.Clear();
                    command.Parameters.AddWithValue("@name", "Franc CFA");
                    command.Parameters.AddWithValue("@abbreviation", "XOF");
                    command.Parameters.AddWithValue("@symbol", "FCFA");
                    command.Parameters.AddWithValue("@conversion", "610");
